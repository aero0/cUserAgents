...
class cUserAgents{
  ...
  // Initializes the class, takes a configuration array and single parameter callback that accepts an array of user agent objects
  initialize(o={},n){
    this.configure(o);
...
function retrieveUserAgents(n){
  ...
  r(requestObj,function(e,r,b){
    // Call callback with 'error' as parameter if request error encountered or if page
    // does contain user agent information
